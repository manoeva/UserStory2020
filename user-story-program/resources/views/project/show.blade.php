            ...
            <div class="row ml-3">
                <div class="col-lg-8">
                    <div class="section_title text-left mb_70">
                        <h3>Project 1</h3>
                        <p class="mb-3">Deskripsi project ini adalah Lorem ipsum dolor sit amet, id pharetra elit hendrerit. Morbi rhoncus maximus nisl. Vivamus lacinia leo a lacus auctor placerat. Vivamus dictum dolor enim. Integer dolor erat, fermentum non lorem venenatis, condimentum eleifend nisl. </p>
                                    ...
                                    <div class="row mb-3">
                                      <div class="col-8">
                                          <div class="form-group">
                                            <label class="text-body">Nama Fitur</label>
                                            <input type="text" class="form-control">
                                          </div>
                                          <div class="form-group">
                                            <label class="text-body">Deskripsi Fitur</label>
                    ...
                    <div class="place_info mx-3 my-2">
                      <table class="table table-borderless">
                        <thead>
                          <tr>
                            <th scope="col">No</th>
                            <th scope="col" style="width:70%">Nama Fitur</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>Fitur {{$i+1}}</td>
                            <td>
                              <a href="{{route('feature.show',['project_id'=>$project_id,'feature_id'=>$i])}}" class="btn btn-sm btn-info">Lihat</a>
